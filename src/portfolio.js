...
const greeting = {
    ...
    title: "Hi, I'm Shivam",
    subTitle: emoji("An aspiring IT engineer 🚀 having an experience in Azure iPaaS services, building Web applications with Nodejs / Express. Machine and Deep Learning Enthusiast specially in field of Computer Vision."),
    resumeLink: ""
};
...
const socialMediaLinks = {
    ...
    linkedin: "https://www.linkedin.com/in/i-l-l-u-s-i-o-n",
...
const skillsSection = {
    ...
    skills: [
        emoji("⚡ Skilled in Azure iPaaS Services(Logic Apps, Service Bus, Function App, APIM, Log Analytics)"),
        emoji("⚡ Actions for Google Assistant."),
        emoji("⚡ AI and ML enthusiast ( Python - SKlearn, Tensorflow, OpenCV)")
    ],
...
const workExperiences = {
    ...
    experience: [ {
        ...
        company: "TATA Consultancy Private Pvt. Ltd.",
